...
/**
 * Alternate controls focused on arm movement and debug
 * seperate from opcontrols.
 * Wheel motor function is disabled while inside this method
 */
//void armControl();

/**
 * Checks a button for program termination
 */
 void thread(void * p);
